...
namespace NND_API
{
	...
	class IVNND4 : public IVNND3
	{
	public:
		/// <summary>
		/// Retrieves the NND-assigned name for the given actor, bypassing the obscurity check.
		/// Returns empty string if NND has no name for this actor.
		/// </summary>
		virtual std::string_view GetRawName(RE::ActorHandle actor) noexcept = 0;
		virtual std::string_view GetRawName(RE::Actor* actor) noexcept = 0;
	};
	...
	[[nodiscard]] inline void* RequestPluginAPI(const InterfaceVersion a_interfaceVersion = InterfaceVersion::kV4) {
